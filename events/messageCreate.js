module.exports = (client, message) => {
    ...
    if (cmd && DJ.enabled && DJ.commands.includes(cmd.name)) {
        ...
        if (!message.member.roles.cache.has('965005882012364910')) return message.channel.send(`This command is reserved for members with the ${DJ.roleName} role on the server ${message.author}... try again ? ❌`);
    }
